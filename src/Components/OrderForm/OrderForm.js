...
import { fetchAddressRequest, fetchCoordsRequest, setIsOrderMade } from '../../Store/Actions';
import { getIsLoadingAddress, getLoadErrorText, getMyAddress, getIsLoadingCoords } from '../../Store/selectors';
...
class OrderForm extends Component {
    static propTypes = {
        fetchAddressRequest: PropTypes.func.isRequired,
    ...
    componentDidMount(){
        const { fetchAddressRequest, MyAddresses } = this.props;
        if(!MyAddresses || MyAddresses.length === 0) fetchAddressRequest();
    }
...
const mapStateToProps = state => ({
    isLoadingAddresses: getIsLoadingAddress(state),
    errorText: getLoadErrorText(state),
    MyAddresses: getMyAddress(state),
    isLoadingCoords: getIsLoadingCoords(state)
});
const mapDispatchToProps = { fetchAddressRequest, fetchCoordsRequest, setIsOrderMade };
